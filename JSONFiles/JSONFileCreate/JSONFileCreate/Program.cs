...
class Program
{
    ...
    static void Main()
    {
        // Creates a file dialog to allow user to select where to save the generated text file w/ a JSON file filter
        ...
        // Generate 100 random people records adds to the list "people"
        for (int i = 0; i < 100; i++)
        {
    ...
    // Random DOB Generator between 1950 and today
    ...
    // Random Phone Number Generator in format XXX-XXX-XXXX
