...
class Program
{
    ...
    static void Main()
    {
        ...
        List<string> cities = new List<string> { "Camden, AL, 36726", "Cold Bay, AK, 99571", "Supai, AZ, 86435", "Almyra, AR, 72003", "Petrolia, CA, 95558", "Bedrock, CO, 81411", "Voluntown, CT, 06384", "Woodside, DE, 19980", "Micanopy, FL, 32667", "Surrency, GA, 31563", "Hana, HI, 96713", "Dixie, ID, 83525", "Metropolis, IL, 62960", "Santa Claus, IN, 47579", "What Cheer, IA, 52593", "Elsmore, KS, 66732", "Mud Lick, KY, 42161", "Branch, LA, 70516", "Allagash, ME, 04735", "Aquasco, MD, 20608", "Shutesbury, MA, 01072", "Skanee, MI, 49962", "Brimson, MN, 55602", "Boyle, MS, 38730", "Sweet Springs, MO, 65351", "Hingham, MT, 59528", "Merna, NE, 68854", "Caliente, NV, 89008", "Center Sandwich, NH, 03227", "Chatsworth, NJ, 08019", "Truth or Consequences, NM, 87901", "Amenia, NY, 12501", "Cary, NC, 27513", "Nome, ND, 58062", "Bainbridge, OH, 45612", "Sweetwater, OK, 73666", "Spray, OR, 97874", "Blue Ball, PA, 17506", "Pascoag, RI, 02859", "Monetta, SC, 29105", "Piedmont, SD, 57769", "Lascassas, TN, 37085", "Cut and Shoot, TX, 77306", "Springdale, UT, 84767", "Lower Waterford, VT, 05848", "Dendron, VA, 23839", "Electric City, WA, 99123", "Hundred, WV, 26575", "Black Earth, WI, 53515", "Emblem, WY, 82422" };
